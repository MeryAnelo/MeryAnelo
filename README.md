<h1 align="center">Mery Mailén Anelo</h1>
...
Backend engineer with 8+ years of experience building and evolving distributed systems, microservices, APIs, and integrations for e-commerce and logistics.

I work primarily with Node.js, TypeScript, and AWS, with a strong background in Java and Spring Boot. I enjoy solving complex backend problems, improving existing architectures, automating repetitive work, and helping development teams become more productive.
...
- Designing and evolving distributed logistics and e-commerce platforms across LATAM.
- Automating onboarding and technical documentation so new engineers can contribute to complex projects in less than a month.
- Optimizing development and operational processes, reducing execution times from hours to minutes or seconds.
- Designing modernization strategies from Java/Spring Boot to Node.js and TypeScript while preserving existing contracts.
- Working with multi-million-record datasets and high-volume batch processing.
- Improving production observability, reliability, API contracts, and AWS resource usage.
- Introducing AI-assisted workflows to improve developer productivity and reduce technical debt.
...
<details>
    ...
    <a href="https://www.summasolutions.net/" target="_blank">Summa Solutions</a> by <a href="https://www.infracommerce.com.br/" target="_blank">Infracommerce</a>
        ...
        <ul>
            <li>07/2023 - Present: Senior Backend Lead </li>
